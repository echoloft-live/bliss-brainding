    ...
    <section id="contact" className="py-[110px] pb-[140px] bg-paper-dim max-md:py-20 max-md:pb-24">
      <div className="max-w-[1200px] mx-auto px-7 max-md:px-5">
        ...
        <div className="grid grid-cols-2 gap-[26px] max-md:grid-cols-1">
          <ContactCard
            icon={<LocationIcon className="w-[19px] h-[19px] text-white" />}
            title="Location"
          ...
          <ContactCard
            icon={<PhoneIcon className="w-[19px] h-[19px] text-white" />}
            title="Phone"
          ...
          <ContactCard
            icon={<WhatsAppIcon className="w-[19px] h-[19px] text-white" stroke="#fff" />}
            title="WhatsApp"
          ...
          >
            ...
            <div className="mt-[6px] h-[130px] rounded-[14px] bg-[linear-gradient(135deg,rgba(110,63,163,0.07),rgba(44,140,135,0.07))] border border-dashed border-violet-soft flex flex-col items-center justify-center gap-[6px] text-[12.5px] text-charcoal-soft text-center p-[14px]">
          ...
          >
            <div className="flex gap-3 mt-[18px]">
              <SocialLink href={SITE.social.tiktok} ariaLabel="TikTok">
                <TikTokIcon className="w-4 h-4" strokeWidth={1.6} />
              </SocialLink>
...
function ContactCard({
  ...
  return (
    <div className="bg-white border border-[var(--color-line)] rounded-[20px] p-[30px] shadow-[var(--shadow-tight)]">
      <div className="w-[38px] h-[38px] rounded-[11px] bg-teal flex items-center justify-center mb-4">
        {icon}
      </div>
      <h4 className="text-[17px] mb-[6px]">{title}</h4>
...
function SocialLink({
  ...
  return (
    <a
      ...
      className="w-[38px] h-[38px] rounded-full border border-violet-soft flex items-center justify-center transition-all duration-300 text-purple-deep hover:bg-teal hover:border-transparent hover:text-white"
    >
      {children}
    </a>
  );
